...
$q=$_SESSION['loginid'];
// echo $q;
$q2="SELECT b.book_id, r.name, b.reg_no,v.vehicle_name, b.date,b.time,b.mileage,a.advname,b.adviser, v.ser_charge FROM `tbl_booking` b, `tbl_vehicle` v, `tbl_reg` r, `tbl_adv` a WHERE b.login_id=r.login_id AND v.vehicle_id=b.vehicle_id AND a.adv_id=b.adviser AND b.status=1 AND a.login_id=$q;"; 
$result=mysqli_query($con,$q2) or die( mysqli_error($con));
if(mysqli_num_rows($result)==0)
{
?>
<div class="container" style="padding: 200px; padding-left: 350px;">
<h1 style="font-weight: bolder;">NO BOOKINGS</h1>
  </div>
  <?php
}
else
                        ...
                        <tbody>
                           ...
                           while ($row = mysqli_fetch_array($result))
                         {
                          ...
                          <tr style="font-size: 30px; font-weight: bold;">
                            ...
                            <input type="submit" class="btn btn-primary btn-icon-text" name="assign" value="Attend">
                          </td>
                          </tr>
                          <?php
                            }}
