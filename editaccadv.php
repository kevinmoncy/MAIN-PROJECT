...
?>
    <!-- HEADER END -->
<div class="container" style="padding-top: 100px; padding-left: 350px;">
<div class="container">
    <h1 style="padding-left: 100px;padding-top: 20px;">Edit Profile</h1>
    <hr>
  <div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form" method="post" action="updateaccadv.php">
          <div class="form-group">
            <label class="col-lg-3 control-label">Name:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" name="name" id="name" value="<?php echo $row['advname']; ?>">
            </div>
          </div>
