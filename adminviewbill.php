...
<div class="container-fluid" >
   <h1 style="text-align: center;padding: 10px;">Service Bill</h1> 
<?php
  require('fun.php');
      $con=connect();
  ...
  $q2="SELECT * FROM  `tbl_reg` r, `tbl_bill` i, `tbl_booking` b,`tbl_vehicle` v  WHERE r.login_id=b.login_id and b.book_id=$bid and v.vehicle_id=b.vehicle_id and i.book_id=b.book_id and i.book_id=$bid";
...
?>
                 ...
                 while ($row = mysqli_fetch_array($result))
  {
              ...
              <tr>
                ...
                <td>
                  Invoice #: <?php echo $row['bill_id'];?><br />
                  Created: <?php echo $row['date']; ?><br />
                  Due: <?php echo $row['date']; ?>
                </td>
              </tr>
            </table>
          </td>
