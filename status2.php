...
$q2="SELECT * FROM `tbl_booking` b, `tbl_vehicle` v, `tbl_reg` r, `tbl_adv` a WHERE b.login_id=r.login_id AND v.vehicle_id=b.vehicle_id AND b.adviser=a.adv_id AND b.login_id=$q and b.status!=2"; 
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class ="confirm">  
                            ...
                            <strong>  
                              <b> <a href="javascript:openulr('cancelbook.php?id=<?php echo $row['book_id']; ?>');" class="btn btn-primary button1"> Confirm to cancel <input type="hidden" name="book_id" id="book_id" value="<?php echo $row['book_id']; ?>"> </a> </b> 
                            </strong>  
                          </div>  
                              ...
                              elseif ($status==1) 
                              {
                                echo " your adviser is ". $row['advname'] . "  please wait for your service update";
                                ?>
                                  </h6>
                                  </div>
                       <div class="row">
                          <div class ="confirm">  
                            ...
                            <strong>  
                              ...
                              elseif ($status==2) 
                              {
                                echo "your vehicle is being serviced please wait for it to finish";
                              }
                                elseif ($status==3) 
                                {
                          ...
                          <strong>  <b> 
                            <a href="javascript:openulr('userbill.php?id=<?php echo $row['book_id']; ?>');" class="btn btn-primary button1"> View Bill <input type="hidden" name="book_id" id="book_id" value="<?php echo $row['book_id']; ?>"> </a> </b> 
                          </strong>  
                          </div>  
                      </div>
