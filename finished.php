...
$q=$_SESSION['loginid'];
$q2="SELECT b.book_id, r.name, b.reg_no,v.vehicle_name, b.date,b.time,b.mileage,a.advname,b.adviser, v.ser_charge FROM `tbl_booking` b, `tbl_vehicle` v, `tbl_reg` r, `tbl_adv` a WHERE b.login_id=r.login_id AND v.vehicle_id=b.vehicle_id AND a.adv_id=b.adviser AND (b.status=3 or b.status=4) AND a.login_id=$q;"; 
                          ...
                          <tr style="font-size: 30px; font-weight: bold;">
                            ...
                            <td><?php echo $row['date']; ?></td>
                             ...
                             <td><?php echo $row['time']; ?></td>
                              ...
                              <td>
                               <?php $b=$row['book_id'];?>
                             <a href='viewbill.php?id=<?php echo $b ?>' class="btn btn-primary btn-icon-text">View Bill</a>
