...
$q=$_SESSION['loginid'];
$q2="SELECT b.book_id, r.name, b.reg_no,v.vehicle_name, b.date,b.time,b.mileage,a.advname,b.adviser FROM `tbl_booking` b, `tbl_vehicle` v, `tbl_reg` r, `tbl_adv` a WHERE b.login_id=r.login_id AND v.vehicle_id=b.vehicle_id and a.adv_id=b.adviser and (b.status!=3 and b.status!=4) ;"; 
