    ...
    <section id="header">
      ...
      <div class="header-slide">
        ...
        var dataHeader = [
            ...
            loaderSVG = new SVGLoader(document.getElementById('loader'), {speedIn : 100, speedOut : 100, easingIn : mina.easeinout});
            loaderSVG.show()
        </script>
          ...
          <div class="col-md-8 animated" data-animate="fadeInLeft">
            <form action="contact.php" method="post">
              <div class="row">
                ...
                <div class="col-md-6">
                  <input type="email" class="form-control" id="cemail" name="cemail" placeholder="Your Email" required>
                </div>
                <div class="col-md-12">
                  <textarea class="form-control" rows="3" id="ccomment" name="ccomment" placeholder="Tell Us Everything" required></textarea>
                </div>
                <div class="col-md-12">
